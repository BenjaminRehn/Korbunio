...
class SearchJobStore:
    ...
    def start(self, postal_code: str, aldi_region: str = "auto", refresh: bool = False, retailers: tuple[str, ...] = (), rewe_market_id: str = "", netto_market_id: str = "", offer_week: str = "current", netto_scottie_market_id: str = "", trinkgut_market_id: str = "") -> str:
        ...
        try:
            self._pool.submit(self._run, job_id, postal_code, aldi_region, refresh, retailers, rewe_market_id, netto_market_id, offer_week, netto_scottie_market_id, trinkgut_market_id)
        except Exception:
            with self._lock:
    ...
    def _run(self, job_id: str, postal_code: str, aldi_region: str, refresh: bool = False, retailers: tuple[str, ...] = (), rewe_market_id: str = "", netto_market_id: str = "", offer_week: str = "current", netto_scottie_market_id: str = "", trinkgut_market_id: str = "") -> None:
        try:
            ...
            if trinkgut_market_id:
                snapshot_kwargs["trinkgut_market_id"] = trinkgut_market_id
            if offer_week == "next":
